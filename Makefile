...
IMAGE_NAME := markuskobler/journalbeat
IMAGE_BUILD_NAME := markuskobler-journalbeat-build
...
build/journalbeat:
	...
	-docker cp $(IMAGE_BUILD_NAME):/go/src/github.com/markuskobler/journalbeat/journalbeat build/journalbeat
